...
"blandit","dolor.","Sed","non","quam.","In","vel","mi","sit","amet","augue","congue","elementum.","Morbi","in","ipsum",
"sit","amet","pede","facilisis","laoreet.","Donec","lacus","nunc,","viverra","nec.",
}

func BenchmarkProcessMessages(b *testing.B) {

	b.Log(runtime.NumCPU())

	for _, np := range []int{1, 2, 4, 8, 16, 128} {

		b.Run(strconv.Itoa(np) + " workers", func(b *testing.B) {

			for i := 0; i < b.N; i++ {
				processMessages(testData, np)
			}
		})
	}
}